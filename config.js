  	...
  	suites:
       {
		 ...
		 reg: 'suites/regression.spec.js'
        //one: ['./Functional/*.js'],
         //two: 'demo.js',
         //api: ['spec/test.spec.js','spec/testapi.spec.js'],
         //api: ['./spec/*.spec.js'],
		// smoke: ['./smoke/*.spec.js'],
		 //all:['./*/*.spec.js']
...
var timestamp = date.getTime();
        ...
        capsPromise.then(function (caps) {
          ...
          // new htmlReporter().from('./reports/xml/xmlresults.xml', testConfig);
		   //new JSONReporter().from('./reports/json/jsonreports.json', testConfig);
        });
    },
